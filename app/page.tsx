...
export default function GifShowcase() {
  return (
    <div className="flex flex-col items-center p-6 space-y-6">
      ...
      <h1 className="text-3xl font-bold">Game GIF Showcase</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {gifCategories.map((category, index) => {
          const [selectedGif, setSelectedGif] = useState(category.gifs[0]);
          return (
      ...
      <footer className="w-full p-4 bg-gray-900 text-white text-center">
        &copy; {new Date().getFullYear()} Game Studio. All rights reserved.
      </footer>
    </div>
  );
}
